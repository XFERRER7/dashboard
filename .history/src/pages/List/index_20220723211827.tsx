...
export const List = () => {
  ...
  return (
    <Container>
      ...
      <Filters>
        <button 
        className={`tag-filter tag-filter-courrent ${frequencySelected.includes('recorrente') && 'isActivate'}`}
        onClick={() => {handleFrequecy('recorrente')}}
        >Recorrentes</button>
        <button 
        className={`tag-filter tag-filter-eventual ${frequencySelected.includes('recorrente') && 'isActivate'}`}
