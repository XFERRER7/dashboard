  ...
  return (
    <Container>
      <HeaderContent titulo={title} lineColor={lineColor}>
        <Select option={options} defaultValue={monthSelected} onChange={(e) => {setMonthSelected(e.target.value)}}/>
        <Select option={optionYear} defaultValue={yearSelected} onChange={(e) => {setYearSelected(e.target.value)}}/>
      </HeaderContent>
