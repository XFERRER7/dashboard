  ...
  return (
    <Container>
      <HeaderContent titulo={title} lineColor={lineColor}>
        <Select option={options} onChange={(e) => {setMonthSelected(e.target.value) console.log()}}/>
        <Select option={optionYear}onChange={(e) => {setYearSelected(e.target.value) console.log()}}/>
      </HeaderContent>
