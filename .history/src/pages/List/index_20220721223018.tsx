  ...
  return (
    <Container>
      <HeaderContent titulo={title} lineColor={lineColor}>
        <Select defaultValue={mont} option={options} onChange={(e) => {setMonthSelected(e.target.value)}}/>
        <Select defaultValue={}'option={optionYear} onChange={(e) => {setYearSelected(e.target.value)}}/>
      </HeaderContent>
