  ...
  return (
    <Container>
      <HeaderContent titulo={title} lineColor={lineColor}>
        <Select defaultValue='10'option={options} onChange={(e) => {setMonthSelected(e.target.value)}}/>
        <Select defaultValue='2022'option={optionYear} onChange={(e) => {setYearSelected(e.target.value)}}/>
      </HeaderContent>
